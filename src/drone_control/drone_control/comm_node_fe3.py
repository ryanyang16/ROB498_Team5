...
class CommNode(Node):
    def __init__(self):
        ...
        self.calib_waypoints = [
            # Bottom Layer (Z = 0.5) - Four Corners and Center
            [-2.0, -2.0, 0.5], # Corner 1
            [2.0, -2.0, 0.5],  # Corner 2
            [0.0, 0.0, 0.5],   # Center
            [2.0, 2.0, 0.5],   # Corner 3
            [-2.0, 2.0, 0.5],  # Corner 4

            # Mid-Air Face Centers (Z = 1.25 approx, using 1.0 and 1.5)
            [-2.0, 0.0, 1.0],  # Left Face
            [0.0, -2.0, 1.0],  # Front Face
            [0.0, 0.0, 1.25],  # Geometric Center (using mid-Z)
            [0.0, 2.0, 1.5],   # Back Face
            [2.0, 0.0, 1.5],   # Right Face

            # Top Layer (Z = 2.0) - Four Corners and Center
            [-2.0, -2.0, 2.0], # Top Corner 1
            [2.0, -2.0, 2.0],  # Top Corner 2
            [0.0, 0.0, 2.0],   # Top Center
            [2.0, 2.0, 2.0],   # Top Corner 3
            [-2.0, 2.0, 2.0]   # Top Corner 4
        ]
